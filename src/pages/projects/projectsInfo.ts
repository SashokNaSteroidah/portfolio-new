...
export const projectsInfo: Array<project> = [
    {
        ...
        year: 2023,
        title: 'DEBETORUM',
        description: "Это проект, который должен из себя представлять конструктор документов для юридических лиц." +
            " В данном проекте я хочу совместить хороший дизайн, который будет удобен большей части пользователей. " +
            "По факту это мой первый проект на библиотеке React, который я делаю. По ссылке ниже вы можете ознакомиться со старым билдом без бекэнда",
        isFinish: false,
    ...
    },
    {
        ...
        description: "Ну и конечно, куда же без сайта, на котором вы сейчас сидите. Этот сайт был создан по причине устаревания прошлого проекта. " +
            "Я его хочу выполнить наиболее профессионально, множество функций еще сюда можно добавить, " +
            "но пока я все буду делать по этапам и выполнять рефакторинг при необходимости. Также оставлю ссылочку для концептов, которые были по ходу разработки",
        isFinish: false,
